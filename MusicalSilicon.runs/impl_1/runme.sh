...
HD_PWD='C:/Users/donov/Desktop/DonovanMPersonalFiles/_GitStored/FPGA/MusicalSilicon/MusicalSilicon/MusicalSilicon.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Channel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Channel.tcl -notrace
