...
HD_PWD='C:/Users/donov/Desktop/DonovanMPersonalFiles/_GitStored/FPGA/MusicalSilicon/MusicalSilicon/MusicalSilicon.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Synthesizer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Synthesizer.tcl
