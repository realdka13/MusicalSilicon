...
## LEDs
#set_property -dict { PACKAGE_PIN H17   IOSTANDARD LVCMOS33 } [get_ports { PWM }]; #IO_L18P_T2_A24_15 Sch=led[0]
...
#set_property -dict { PACKAGE_PIN D12   IOSTANDARD LVCMOS33 } [get_ports { AUD_EN }]; #IO_L6P_T0_15 Sch=aud_sd
